    ...
    <div class="card-body">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <form action="{{ route('tanyas.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <textarea name="pertanyaan" class="form-control" rows="3" placeholder="Tulis pertanyaan kamu..." required></textarea>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Upload Screenshot Blender (opsional)</label>
        ...
        @else
            <div class="alert alert-info">
                Silakan <a href="{{ route('login') }}">login</a> untuk bertanya.
            </div>
        @endauth
                            ...
                            @if ($tanya->user_id == Auth::id())
                                <form action="{{ route('tanyas.destroy', $tanya->id) }}" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-outline-danger"
                                        onclick="return confirm('Hapus pertanyaan?')">
                                        Hapus
                                    </button>
                                </form>
                            @endif
                    ...
                    @auth
                        <form action="{{ route('jawabs.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="input-group">
                                <textarea name="jawaban" class="form-control" rows="2" placeholder="Tulis jawaban..." required></textarea>
