    ...
    <div class="container">
        ...
        @if ($showcases->isEmpty())
            <div class="text-center py-5">
                ...
                <a href="{{ route('learn.showcase.create') }}" class="modul-btn" style="width:auto;display:inline-block;">
                    <i class="bi bi-plus-lg me-1"></i> Upload Sekarang
                </a>
            </div>
                           ...
                           style="text-decoration:none;">
                            <div style="aspect-ratio:4/3;overflow:hidden;background:#111;position:relative;">
                                @if ($showcase->resources->isNotEmpty())
                                    @if ($showcase->resources->first()->type === 'video')
                                        <div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:#1a1a2e;">
                                            <i class="bi bi-play-circle-fill" style="font-size:3rem;color:#fff;opacity:0.8;"></i>
                                        </div>
                                    @else
                                    ...
                                    @endif
                                @else
                                    <div style="width:100%;height:100%;display:flex;align-items:center;justify-content:center;background:#2a2a3e;">
                                ...
                                @if ($showcase->resources->count() > 1)
                                    <span style="position:absolute;top:10px;right:10px;background:rgba(0,0,0,0.65);color:#fff;font-size:0.75rem;padding:3px 8px;border-radius:20px;backdrop-filter:blur(4px);">
                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-auto"
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <span>
                                        <i class="bi bi-clock me-1"></i>{{ $showcase->created_at->diffForHumans() }}
                                    </span>
                                </div>
                            </div>
                        </div>
