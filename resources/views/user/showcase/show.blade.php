...
@push('styles')
    ...
    <style>
        .media-single { border-radius: 12px; overflow: hidden; background: #111; max-height: 520px; }
        .media-single img, .media-single video { width: 100%; max-height: 520px; object-fit: contain; display: block; }
        .media-thumb { border-radius: 8px; overflow: hidden; aspect-ratio: 16/9; background: #111; cursor: pointer; }
        ...
        .komentar-item + .komentar-item { border-top: 1px solid #f0f0f0; }
        .komentar-item { padding: 0.875rem 0; }
    </style>
@endpush
                ...
                <div class="media-single mb-3" id="mainMedia">
                    ...
                    @else
                        <img src="{{ $showcase->resources->first()->url }}"
                             alt="{{ $showcase->judul }}" id="mainMediaEl">
                    @endif
                </div>
                {{-- Thumbnails --}}
            ...
            <div class="card-body">
                <h5 class="fw-bold mb-4">
                    ...
                    <span class="badge ms-1"
                          style="background:#f0f0f0;color:#333;font-size:0.8rem;font-weight:600;">
                ...
                {{-- Form komentar --}}
                @auth
                    <form action="{{ route('learn.showcase.komentar.store', $showcase) }}"
                        ...
                        <div class="d-flex gap-2 align-items-start">
                            ...
                            <div class="flex-grow-1">
                                <textarea name="komentar" class="form-control mb-2"
                                          rows="2" placeholder="Tulis komentar..."
                                          required style="resize:none;font-size:0.9rem;"></textarea>
                        ...
                        <div class="d-flex align-items-start gap-2">
                            ...
                            <div class="flex-grow-1">
                                <div class="d-flex align-items-center justify-content-between gap-2">
                                    <div>
                                        <span style="font-weight:600;font-size:0.875rem;">{{ $komentar->user->name }}</span>
